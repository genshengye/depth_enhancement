...
%% Choose models
s = [struct('string','Bilateral_Filter','run',false)
     struct('string','Bilateral_Upsampling','run',false)
     struct('string','Noise-aware_Filter','run',false)
     struct('string','Weight_Mode_Filter','run',false)
     struct('string','Anisotropic_Diffusion','run',true)
     struct('string','Original_Markov_Random_Field','run',false)
     struct('string','Markov_Random_Field(Second_Order_Smoothness)','run',false)
     struct('string','Markov_Random_Field(Kernel_Data_Term)','run',false)
     struct('string','Markov_Random_Field(Tensor)','run',false)
     struct('string','Layered_Bilateral_Filter','run',false)
    ];
...
%%%   Bilateral Filter                
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if(isequal(s(i).string,'Bilateral_Filter') && s(i).run)
...
if(isequal(s(i).string,'Bilateral_Upsampling') && s(i).run)
	fprintf([s(i).string ' begin...\n'])
    tic
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if(isequal(s(i).string,'Anisotropic_Diffusion') && s(i).run)
	fprintf([s(i).string ' begin...\n'])
    tic
...
%%%   Noise-aware Filter     
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if(isequal(s(i).string,'Noise-aware_Filter') && s(i).run)
	fprintf([s(i).string ' begin...\n'])
    tic
...
%%%   Weight Mode Filter 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if(isequal(s(i).string,'Weight_Mode_Filter') && s(i).run)
	fprintf([s(i).string ' begin...\n'])
    tic
...
%%% Original MRF
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if(isequal(s(i).string,'Original_Markov_Random_Field') && s(i).run)
    fprintf([s(i).string ' begin...\n'])
    tic
    if(MRF_method == 1)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if(isequal(s(i).string,'Layered_Bilateral_Filter') && s(i).run)
    fprintf([s(i).string ' begin...\n'])
    tic
...
%%% Second Order MRF
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if(isequal(s(i).string,'Markov_Random_Field(Second_Order_Smoothness)') && s(i).run)
    fprintf([s(i).string ' begin...\n'])
    tic
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if(isequal(s(i).string,'Markov_Random_Field(Kernel_Data_Term)') && s(i).run)
    fprintf([s(i).string ' begin...\n'])
    tic
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if(isequal(s(i).string,'Markov_Random_Field(Tensor)') && s(i).run)
    fprintf([s(i).string ' begin...\n'])
    tic
